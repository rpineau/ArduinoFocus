...
int	X2Focuser::amountNameFromIndexFocGoto(const int& nZeroBasedIndex, BasicStringInterface& strDisplayName, int& nAmount)
{
	...
	{
		default:
        case 0: strDisplayName="1 steps"; nAmount=11;break;
		case 1: strDisplayName="5 steps"; nAmount=5;break;
		case 2: strDisplayName="10 steps"; nAmount=10;break;
        case 3: strDisplayName="50 steps"; nAmount=50;break;
        case 4: strDisplayName="100 steps"; nAmount=100;break;
        case 5: strDisplayName="500 steps"; nAmount=500;break;
        ...
        case 9: strDisplayName="50000 steps"; nAmount=50000;break;
	}
	return SB_OK;
}
